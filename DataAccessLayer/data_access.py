...
DATABASE_URL = os.getenv("DATABASE_URL", "mssql+pyodbc://DESKTOP-4UC3VNU/QuanLyKhamBenhDB?driver=ODBC+Driver+17+for+SQL+Server&Trusted_Connection=yes&Encrypt=yes&TrustServerCertificate=yes")
