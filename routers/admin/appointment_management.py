...
def get_all_appointments(
    ...
    appointment_statuses: Optional[str] = None,
    ...
    if appointment_statuses:
        statuses_list = [s.strip() for s in appointment_statuses.split(',')]
    
    return business_logic.get_all_appointments_logic(db, statuses=statuses_list, date=appointment_date)
